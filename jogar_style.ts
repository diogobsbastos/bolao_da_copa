...
.sl{position:absolute;inset:0;background:#9aa3b5;border:1px solid #9aa3b5;border-radius:999px;transition:.2s}
...
.sw input:checked+.sl{background:#14a06a;border-color:#14a06a}
