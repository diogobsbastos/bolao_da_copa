...
.pack{position:relative;border:1px solid var(--bd);border-radius:14px;padding:14px;background:linear-gradient(160deg,var(--card2),var(--card))}.pkflag{position:absolute;top:0;right:0;display:flex;align-items:center;gap:5px;background:linear-gradient(135deg,#ffe07a,#e0a008);color:#3a2a00;font-weight:800;font-size:13px;padding:5px 13px;border-radius:0 14px 0 14px;box-shadow:0 4px 12px rgba(0,0,0,.35);z-index:3}.pkflag .pkcoin{font-size:14px;line-height:1;flex:none;filter:drop-shadow(0 1px 1px rgba(0,0,0,.45))}.pkflag .pkval{font-size:13px;font-weight:900;line-height:1}
