...
.pwrap{position:relative;display:inline-flex;align-items:center}.pchev{position:absolute;bottom:-1px;right:-1px;width:14px;height:14px;border-radius:50%;background:#d6f5e3;border:2px solid var(--panel);color:#0f7a45;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:3}.pchev svg{width:9px;height:9px;display:block}.pchev:hover{background:#c0eecf}
.av{overflow:hidden}
