...
.blogo{height:30px;width:auto;display:block;flex:none;filter:drop-shadow(0 3px 8px rgba(0,0,0,.4))}.brand .btxt{display:inline-flex;align-items:flex-start;gap:5px}.brand .bcol{display:inline-flex;flex-direction:column;align-items:center;line-height:1.05}.brand .bbeta{font-size:7px;font-weight:600;letter-spacing:0;color:var(--mut);text-transform:none;opacity:.85;margin-top:1px}
