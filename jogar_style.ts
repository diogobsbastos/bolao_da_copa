...
.origb{position:absolute;right:0;bottom:0;font-size:7px;font-weight:400;letter-spacing:.2px;padding:1px 6px;border-radius:7px 0 11px 0;color:var(--rc,#14a06a);background:color-mix(in srgb,var(--rc,#14a06a) 10%,transparent);opacity:.9;z-index:2}.actpanel{position:relative}.actcol{position:absolute;top:-7px;right:-7px;width:15px;height:15px;border-radius:50%;border:1.5px solid var(--surface);background:var(--rc,#14a06a);color:#fff;font-size:10px;font-weight:800;cursor:pointer;line-height:1;z-index:6;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,.3)}.actcol:hover{transform:scale(1.1)}.autofab{position:fixed;right:18px;bottom:84px;border:0;background:none;cursor:pointer;z-index:55;flex-direction:column;align-items:center;gap:1px;padding:0}.autofabrobo{width:56px;height:56px;filter:drop-shadow(0 6px 14px rgba(0,0,0,.45));animation:bob 2.6s ease-in-out infinite}.autofablbl{font-size:10px;font-weight:800;color:#fff;background:var(--pri);padding:2px 10px;border-radius:999px;box-shadow:0 3px 8px rgba(0,0,0,.3);white-space:nowrap}.pghover{position:absolute;top:-14px;right:6px;display:inline-flex;gap:10px;background:var(--surface);border:1px solid var(--bd);border-radius:8px;padding:3px 10px;box-shadow:0 4px 12px rgba(0,0,0,.2);opacity:0;pointer-events:none;transition:opacity .15s;z-index:6;white-space:nowrap}.jogo:hover .pghover{opacity:1;pointer-events:auto}.pghover .pgia,.pghover .pglog{cursor:pointer;font-size:11px;font-weight:700;color:var(--tx)}.pghover .pgia:hover{color:#d99a1f}.pghover .pglog:hover{color:var(--pri2)}.pgia:hover,.pglog:hover{opacity:1}.autob{font-size:8px;font-weight:800;background:var(--surface2);color:var(--mut);padding:1px 5px;border-radius:6px;letter-spacing:.5px}
