...
.pwrap{position:relative;display:inline-flex;align-items:center}.pchev{position:absolute;bottom:-1px;right:-1px;width:16px;height:16px;border-radius:50%;background:var(--card2);border:2px solid var(--panel);color:var(--tx);display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:3}.pchev svg{width:9px;height:9px;display:block}.pchev:hover{background:var(--pri);color:#fff}
.av{overflow:hidden}
