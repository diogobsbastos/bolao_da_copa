...
.side a.navfull .navfreesel{background:#f5c451;color:#fff;font-size:9px;font-weight:800;padding:1px 6px;border-radius:999px;margin-left:auto;position:relative;animation:radarg 1.8s ease-out infinite}
