...
.mpstatus .dot{width:9px;height:9px;border-radius:50%;background:var(--gold);animation:pulsedot 1.2s infinite}.dotr{position:relative}.dotr::after{content:"";position:absolute;inset:0;border-radius:50%;box-shadow:0 0 0 0 rgba(245,196,81,.6);animation:radarg 1.8s ease-out infinite}@keyframes radarg{0%{box-shadow:0 0 0 0 rgba(245,196,81,.55)}70%{box-shadow:0 0 0 9px rgba(245,196,81,0)}100%{box-shadow:0 0 0 0 rgba(245,196,81,0)}}.tmsoon{opacity:.5;pointer-events:none}.tmsoon .v{font-size:13px}.tmprev{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:12px;opacity:.55;pointer-events:none}.tmprevlab{font-size:10px;font-weight:800;text-transform:uppercase;color:#cf8f12}.tmprevopt{font-size:11px;font-weight:700;background:var(--card2);border:1px solid var(--bd);border-radius:7px;padding:3px 9px;color:var(--mut)}
