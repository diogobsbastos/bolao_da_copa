...
.pack{position:relative;border:1px solid var(--bd);border-radius:14px;padding:14px;background:linear-gradient(160deg,var(--card2),var(--card))}.pkflag{position:absolute;top:10px;right:10px;display:inline-flex;align-items:center;gap:6px;background:linear-gradient(145deg,#ffef9e,#f5c451 45%,#cf8f12);color:#3a2600;padding:5px 12px 5px 7px;border-radius:999px;border:1px solid rgba(255,255,255,.45);box-shadow:0 6px 16px rgba(170,115,10,.45),inset 0 1px 1px rgba(255,255,255,.7);z-index:3;overflow:hidden}.pkflag::after{content:"";position:absolute;inset:0;background:linear-gradient(115deg,transparent 40%,rgba(255,255,255,.55) 50%,transparent 60%);transform:translateX(-130%);animation:pkshine 3.4s ease-in-out infinite;pointer-events:none}@keyframes pkshine{0%{transform:translateX(-130%)}55%,100%{transform:translateX(130%)}}.pkflag .pkcoin{width:21px;height:21px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#fff6cf,#e7a812);display:flex;align-items:center;justify-content:center;font-size:12px;box-shadow:inset 0 0 0 1.5px rgba(150,98,0,.45)}.pkflag .pkval{font-size:15px;font-weight:900;line-height:1}.pkflag .pktok{font-size:8px;font-weight:800;letter-spacing:.6px;opacity:.72;align-self:flex-end;margin:0 0 2px -2px}
