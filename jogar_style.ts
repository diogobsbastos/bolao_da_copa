...
.btnclube{width:auto;align-self:center;padding:9px 18px;font-size:13px;font-weight:800;margin-top:10px;border-radius:10px;box-shadow:0 4px 10px rgba(15,122,69,.25)}
.btnclube:hover{transform:translateY(-1px)}
.hmprev{align-items:center;text-align:center}
