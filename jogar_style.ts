...
.hmrod{display:flex;align-items:center;gap:14px;background:linear-gradient(135deg,rgba(31,170,89,.16),rgba(31,170,89,.05));border:1px solid rgba(31,170,89,.45);border-radius:14px;padding:14px 16px;margin-bottom:16px}.hmrobo{width:50px;height:50px;flex:none;animation:bob 2.6s ease-in-out infinite}.hmrbody{flex:1;min-width:0}.hmbubble{position:relative;display:inline-block;background:var(--surface2);border:1px solid var(--bd);border-radius:12px;padding:7px 12px;font-size:13px;font-weight:600;margin-bottom:8px}.hmbubble:before{content:'';position:absolute;left:-7px;top:14px;border:7px solid transparent;border-right-color:var(--bd)}.hmbubble b{color:var(--pri2)}.hmmeta{font-size:12px;color:var(--mut)}.hmmeta b{color:var(--tx)}.hmkpis{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-bottom:16px}.hmkpi{background:var(--surface);border:1px solid var(--bd);border-radius:12px;padding:13px 15px}.hmkpi h3{font-size:11px;color:var(--mut);font-weight:700;margin:0 0 4px}.hmkpi .stat{font-size:26px;font-weight:800;line-height:1}.hmkpi .stat.green{color:var(--pri2)}.hmcols{display:grid;grid-template-columns:1.02fr .98fr;gap:16px;align-items:start}.hmfwrap{position:relative;border-radius:14px;overflow:hidden;border:1px solid var(--bd)}.hmfield{display:block;width:100%}body.light .hmpitch{fill:#1a8f54}body.light .hmlines{stroke:#bfe6d2}.hmprev{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:16px;background:radial-gradient(circle at 50% 45%,rgba(8,13,24,.32),rgba(8,13,24,.62))}.hmprev .soon{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--gold);background:rgba(245,196,81,.16);border:1px solid rgba(245,196,81,.5);border-radius:999px;padding:3px 11px;margin-bottom:8px}.hmprev b{font-size:15px;color:#fff}.hmprev span{font-size:12px;color:#c3ccd9;max-width:230px;margin:3px 0 12px}@media(max-width:680px){.hmkpis{grid-template-columns:1fr 1fr}.hmcols{grid-template-columns:1fr}}\n@media(min-width:761px) and (max-width:1024px){body{zoom:.82}.layout{min-height:calc(100vh / 0.82 - 52px)}.side{min-height:calc(100vh / 0.82 - 52px)}}
