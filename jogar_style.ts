...
.mpstatus .dot{width:9px;height:9px;border-radius:50%;background:var(--gold);animation:pulsedot 1.2s infinite}.dotr{position:relative}.dotr::after{content:"";position:absolute;inset:0;border-radius:50%;box-shadow:0 0 0 0 rgba(245,196,81,.6);animation:radarg 1.8s ease-out infinite}@keyframes radarg{0%{box-shadow:0 0 0 0 rgba(245,196,81,.55)}70%{box-shadow:0 0 0 9px rgba(245,196,81,0)}100%{box-shadow:0 0 0 0 rgba(245,196,81,0)}}.tmprev{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:12px;opacity:.55;pointer-events:none}.tmprevlab{font-size:10px;font-weight:800;text-transform:uppercase;color:#cf8f12}.tmprevopt{font-size:11px;font-weight:700;background:var(--card2);border:1px solid var(--bd);border-radius:7px;padding:3px 9px;color:var(--mut)}
...
.origb{position:absolute;right:8px;bottom:6px;font-size:8.5px;font-weight:800;padding:2px 7px;border-radius:7px;letter-spacing:.2px;opacity:.92;z-index:2}.origb.origia{background:rgba(47,111,237,.15);color:#2f6fed}.origb.origlog{background:rgba(245,196,81,.22);color:#cf8f12}.origb.origman{background:rgba(31,170,89,.15);color:var(--pri2)}.actpanel{position:relative}.actcol{position:absolute;top:7px;right:9px;width:22px;height:22px;border-radius:50%;border:0;background:rgba(0,0,0,.06);color:var(--mut);font-size:11px;cursor:pointer;line-height:1;z-index:3;display:flex;align-items:center;justify-content:center}.actcol:hover{background:rgba(0,0,0,.12)}.autofab{position:fixed;right:18px;bottom:84px;width:56px;height:56px;border-radius:50%;border:0;background:linear-gradient(135deg,var(--pri),var(--pri2));color:#fff;font-size:26px;cursor:pointer;box-shadow:0 8px 24px rgba(31,170,89,.5);z-index:55;align-items:center;justify-content:center;animation:bob 2.6s ease-in-out infinite}.pghover{position:absolute;top:-9px;left:50%;transform:translateX(-50%);display:inline-flex;gap:10px;background:var(--surface);border:1px solid var(--bd);border-radius:8px;padding:3px 10px;box-shadow:0 4px 12px rgba(0,0,0,.2);opacity:0;pointer-events:none;transition:opacity .15s;z-index:6;white-space:nowrap}.jogo:hover .pghover{opacity:1;pointer-events:auto}.pghover .pgia,.pghover .pglog{cursor:pointer;font-size:11px;font-weight:700;color:var(--tx)}.pghover .pgia:hover{color:#d99a1f}.pghover .pglog:hover{color:var(--pri2)}.pgia:hover,.pglog:hover{opacity:1}.autob{font-size:8px;font-weight:800;background:var(--surface2);color:var(--mut);padding:1px 5px;border-radius:6px;letter-spacing:.5px}
