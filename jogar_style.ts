...
.pack{position:relative;border:1px solid var(--bd);border-radius:14px;padding:14px;background:linear-gradient(160deg,var(--card2),var(--card))}.pkflag{position:absolute;top:9px;right:9px;display:inline-flex;align-items:center;gap:4px;background:linear-gradient(145deg,#ffef9e,#f5c451 45%,#cf8f12);color:#3a2600;padding:3px 9px 3px 5px;border-radius:999px;border:1px solid rgba(255,255,255,.45);box-shadow:0 5px 13px rgba(170,115,10,.4),inset 0 1px 1px rgba(255,255,255,.7);z-index:3;overflow:hidden}.pkflag::after{content:"";position:absolute;inset:0;background:linear-gradient(115deg,transparent 40%,rgba(255,255,255,.5) 50%,transparent 60%);transform:translateX(-130%);animation:pkshine 3.4s ease-in-out infinite;pointer-events:none}@keyframes pkshine{0%{transform:translateX(-130%)}55%,100%{transform:translateX(130%)}}.pkflag .pkcoin{width:17px;height:17px;display:block;flex:none}.pkflag .pkval{font-size:13.5px;font-weight:900;line-height:1}
