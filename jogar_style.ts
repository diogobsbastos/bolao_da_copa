...
.w{display:flex;align-items:center;justify-content:center;gap:5px;background:var(--card2);border:1px solid var(--bd);border-radius:999px;padding:5px 10px;font-size:12px;font-weight:700}
...
.pack{position:relative;border:1px solid var(--bd);border-radius:14px;padding:14px;background:linear-gradient(160deg,var(--card2),var(--card))}.pack.soonpack{display:flex;flex-direction:column}.soonmid{flex:1;display:flex;align-items:center;justify-content:center;min-height:130px}.pksoon2{display:inline-flex;align-items:center;gap:5px;background:linear-gradient(135deg,#ffd24d,#e0a008);color:#3a2a00;font-weight:800;font-size:13px;letter-spacing:.6px;padding:7px 16px;border-radius:999px;box-shadow:0 4px 12px rgba(0,0,0,.2)}.pksoon{position:absolute;top:0;right:0;background:linear-gradient(135deg,#ffd24d,#e0a008);color:#3a2a00;font-weight:800;font-size:10px;letter-spacing:.5px;padding:4px 11px;border-radius:0 14px 0 14px;box-shadow:0 3px 9px rgba(0,0,0,.22);z-index:3}.pkflag{position:absolute;top:0;right:0;display:flex;align-items:center;gap:5px;background:linear-gradient(135deg,#ffe07a,#e0a008);color:#3a2a00;font-weight:800;font-size:13px;padding:5px 13px;border-radius:0 14px 0 14px;box-shadow:0 4px 12px rgba(0,0,0,.35);z-index:3}.pkflag .pkcoin{width:16px;height:16px;display:block;flex:none}.wcoin{width:15px;height:15px;vertical-align:-3px}.pkflag .pkval{font-size:13px;font-weight:900;line-height:1}
...
.mpstatus .dot{width:9px;height:9px;border-radius:50%;background:var(--gold);animation:pulsedot 1.2s infinite}.dotr{position:relative;display:inline-block;flex:none;width:9px;height:9px;border-radius:50%;background:var(--gold);margin-left:auto;margin-right:6px}.dotr::after{content:"";position:absolute;inset:0;border-radius:50%;box-shadow:0 0 0 0 rgba(245,196,81,.6);animation:radarg 1.8s ease-out infinite}@keyframes radarg{0%{box-shadow:0 0 0 0 rgba(245,196,81,.55)}70%{box-shadow:0 0 0 9px rgba(245,196,81,0)}100%{box-shadow:0 0 0 0 rgba(245,196,81,0)}}.tmsoon{opacity:.5;pointer-events:none}.tmsoon .v{font-size:12px}.tmprev{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:12px;opacity:.55;pointer-events:none}.tmprevlab{font-size:10px;font-weight:800;text-transform:uppercase;color:#cf8f12}.tmprevopt{font-size:11px;font-weight:700;background:var(--card2);border:1px solid var(--bd);border-radius:7px;padding:3px 9px;color:var(--mut)}
...
.tag{display:inline-block;padding:2px 8px;border-radius:999px;font-size:10px;font-weight:700;background:var(--surface2);color:var(--pri2)}.tag.lk{color:var(--no);font-size:8px;padding:1px 6px}
...
.blogo{height:30px;width:auto;display:block;flex:none;filter:drop-shadow(0 3px 8px rgba(0,0,0,.4))}.brand .bcol{display:inline-flex;flex-direction:column;align-items:flex-end;line-height:1.05}.brand .bbeta{font-size:8px;font-weight:800;letter-spacing:.5px;color:var(--tx);text-transform:none;margin-top:1px}
...
body.mcol .side a .tag,body.mcol .side a .free,body.mcol .side a .dot,body.mcol .side a .dotr{display:none}\nbody.mcol .side .radar{display:none}
...
.modal .btn:not(.ghost){background:var(--bar,#14a06a);box-shadow:0 4px 12px rgba(0,0,0,.18);color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.25)}
...
.origb{position:absolute;right:0;bottom:0;font-size:7px;font-weight:400;letter-spacing:.2px;padding:1px 6px;border-radius:7px 0 11px 0;color:var(--rc,#14a06a);background:color-mix(in srgb,var(--rc,#14a06a) 10%,transparent);opacity:.9;z-index:2}.actpanel{position:relative}.actcol{position:absolute;top:-7px;right:-7px;z-index:6;width:15px;height:15px;border-radius:50%;background:var(--rc,#14a06a);border:1.5px solid var(--surface);color:#fff;font-size:10px;font-weight:800;line-height:1;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 1px 4px rgba(0,0,0,.3);transition:transform .15s}.actcol:hover{transform:scale(1.1)}body.light .sl{background:#9aa3b5!important;border-color:#9aa3b5!important}body.light .sw input:checked+.sl{background:var(--pri)!important;border-color:var(--pri)!important}body.light .actcol{background:var(--pri)!important;border-color:#fff!important;color:#fff!important}body.light .sl{background:#9aa3b5;border-color:#9aa3b5}body.light .sw input:checked+.sl{background:var(--rc,var(--pri));border-color:var(--rc,var(--pri))}body.light .actcol{background:#2b3340;border-color:#fff;color:#fff}.autofab{position:fixed;right:18px;bottom:84px;border:0;background:none;cursor:pointer;z-index:55;flex-direction:column;align-items:center;gap:1px;padding:0}.autofabtop{position:relative;display:block;animation:bob 2.6s ease-in-out infinite}.autofabtop::before{content:"";position:absolute;top:50%;left:50%;width:72px;height:72px;transform:translate(-50%,-50%);border-radius:50%;background:radial-gradient(circle,color-mix(in srgb,var(--rc,#14a06a) 60%,transparent),transparent 62%);z-index:0;pointer-events:none;animation:fabpulse 2.2s ease-in-out infinite}@keyframes fabpulse{0%,100%{opacity:.45;transform:translate(-50%,-50%) scale(.88)}50%{opacity:.95;transform:translate(-50%,-50%) scale(1.12)}}.autofabrobo{position:relative;z-index:1;display:block;width:56px;height:56px}.autofablbl{position:relative;z-index:1;margin-top:-7px;font-size:10px;font-weight:800;color:var(--rc,#14a06a);background:#fff;padding:2px 11px;border-radius:999px;box-shadow:0 4px 12px rgba(0,0,0,.28);white-space:nowrap}.pghover{position:absolute;top:-14px;right:24px;display:inline-flex;gap:10px;background:var(--surface);border:1px solid var(--bd);border-radius:8px;padding:3px 10px;box-shadow:0 4px 12px rgba(0,0,0,.2);opacity:0;pointer-events:none;transition:opacity .15s;z-index:6;white-space:nowrap}.jogo:hover .pghover{opacity:1;pointer-events:auto}.pghover .pgia,.pghover .pglog{cursor:pointer;font-size:11px;font-weight:700;color:var(--tx)}.pghover .pgia:hover{color:#d99a1f}.pghover .pglog:hover{color:var(--pri2)}.pgia:hover,.pglog:hover{opacity:1}.autob{font-size:8px;font-weight:800;background:var(--surface2);color:var(--mut);padding:1px 5px;border-radius:6px;letter-spacing:.5px}
...
.pacov{position:fixed;inset:0;background:rgba(245,196,81,.18);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:flex;align-items:center;justify-content:center;z-index:9000;opacity:0;transition:opacity .2s ease;padding:20px}
.pacov.on{opacity:1}
.pacbox{position:relative;max-width:340px;width:100%}
.pacbox .pack.base{margin:0}
.pacx{position:absolute;top:-12px;left:-12px;background:#fff;color:#1a2233;border:2px solid #e6ad12;border-radius:50%;width:32px;height:32px;cursor:pointer;font-size:18px;font-weight:800;line-height:1;z-index:20;box-shadow:0 4px 10px rgba(0,0,0,.3)}
.pacx:hover{background:#f4f6f9}
#s-convidar .card{color:#fff}
#s-convidar .card .muted{color:#c3ccd9}
#s-convidar .card b{color:#fff}
#s-convidar .card h3{color:#fff}
...
.mptitle{font-size:13px;font-weight:800;color:var(--mut);text-transform:uppercase;letter-spacing:.4px;text-align:center;margin:2px 0 10px}
.mpcards{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px;margin-bottom:12px}
.mpcard{position:relative;display:flex;flex-direction:column;align-items:stretch;text-align:center;background:#fff;border:1.5px solid #e2e6ee;border-radius:14px;padding:14px 12px 12px;cursor:pointer;transition:.15s;box-shadow:0 2px 6px rgba(20,30,60,.04)}
.mpcard:hover{border-color:#009ee3;transform:translateY(-1px);box-shadow:0 6px 16px rgba(0,158,227,.18)}
.mpcard.mpdst{border-color:#1faa59;background:linear-gradient(180deg,#f5fbf7 0%,#fff 60%);box-shadow:0 4px 12px rgba(31,170,89,.15)}
.mpcard.mpdst::before{content:"\\2728 Recomendado";position:absolute;top:-9px;left:50%;transform:translateX(-50%);background:#1faa59;color:#fff;font-size:10px;font-weight:800;padding:3px 10px;border-radius:999px;letter-spacing:.3px;white-space:nowrap}
.mpctop{display:flex;justify-content:space-between;align-items:center;min-height:18px;font-size:11px;margin-bottom:4px}
...
.mpcard:hover .mpcgo{background:#0089c7}
.mperr{background:#fdecec;border:1px solid #f5b5b5;color:#a32424;border-radius:10px;padding:10px;font-size:13px;font-weight:700;text-align:center}
.okprize{display:inline-block;background:linear-gradient(90deg,#f5c451,#e0a008);color:#3a2a08;font-weight:800;font-size:15px;padding:8px 16px;border-radius:999px;margin:6px 0 4px;box-shadow:0 2px 8px rgba(224,160,8,.3)}
.okprize b{font-size:18px}
...
.ob-x{position:absolute;top:10px;right:12px;background:transparent;border:0;font-size:24px;color:#9aa1b0;cursor:pointer;width:32px;height:32px;border-radius:50%;line-height:1}
.ob-x:hover{background:#eef1f6;color:#1a2233}
.ob-emoji{font-size:54px;line-height:1;margin-bottom:4px;filter:drop-shadow(0 4px 12px rgba(224,160,8,.4))}
.ob-h1{font-size:22px;font-weight:900;margin:8px 0 6px;color:#1a2233}
.ob-sub{font-size:14px;color:#5b6472;line-height:1.5;margin-bottom:18px}
.ob-sub b{color:#1a2233}
.ob-pkg{background:linear-gradient(135deg,#eef9f3 0%,#fff8e8 100%);border:1.5px solid #cfe9da;border-radius:14px;padding:14px;margin-bottom:18px}
.ob-pkgrl{display:flex;align-items:center;justify-content:space-around;gap:6px;font-size:12px;color:#5b6472}
.ob-pkgrl b{display:block;font-size:22px;font-weight:900;color:#1a2233}
.ob-pkgrl small{color:#9aa1b0;font-size:11px}
.ob-arrow{font-size:22px;color:#1faa59;font-weight:900}
...
@media(max-width:540px){.ob-box{padding:24px 18px 18px;border-radius:18px}.ob-h1{font-size:19px}
...
/* POLISH-RUNNING 2026-06-13-01 */
@media(max-width:600px){
 /* (vazio por enquanto — pronto pra receber proximos ajustes) */
}


/* POLISH-RUNNING-CSS 2026-06-13-02 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-03 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-04 */
@media(max-width:600px){
 /* === Marketplace: pack landscape, info topo direita, espaco esquerdo === */
 ...
 .pack.base{display:grid!important;grid-template-columns:130px 1fr!important;grid-template-rows:1fr!important;width:100%!important;max-width:100%!important;min-height:0!important;height:auto!important;padding:0!important;overflow:hidden!important;align-items:stretch!important;gap:0!important;margin-left:0!important}
 .pack.base>img,.pack.base>picture,.pack.base>[class*=img],.pack.base>[class*=fig]{width:100%!important;height:100%!important;max-width:130px!important;object-fit:cover!important;align-self:stretch!important;margin:0!important;border-radius:0!important;display:block!important;grid-column:1!important;grid-row:1!important}
 .pack.base>*:not(img):not(picture):not([class*=img]):not([class*=fig]){padding:14px 14px 14px 14px!important;align-self:start!important;grid-column:2!important;min-width:0!important;display:flex!important;flex-direction:column!important;justify-content:flex-start!important}
 .pack.base h3,.pack.base [class*=title]{font-size:17px!important;margin:0 0 6px!important;line-height:1.15!important;font-weight:700}
 .pack.base p,.pack.base [class*=desc],.pack.base [class*=sub]{font-size:13px!important;line-height:1.35!important;margin:0 0 6px!important}
 .pack.base .pksoon,.pack.base .pksoon2,.pack.base [class*=embreve],.pack.base [class*=badge]{font-size:11px!important;padding:4px 10px!important;display:inline-flex!important}
 .pack.base button,.pack.base [class*=btn]{padding:8px 14px!important;font-size:12px!important;width:100%!important;margin-top:6px!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-06 */
@media(max-width:600px){
 /* === Marketplace === */
 .grid:has(> .pack){grid-template-columns:1fr!important;gap:14px!important;padding-left:12px!important;padding-right:12px!important}
 .pack.base{display:grid!important;grid-template-columns:130px 1fr!important;grid-template-rows:auto!important;width:100%!important;max-width:100%!important;min-height:0!important;height:auto!important;padding:0!important;overflow:hidden!important;align-items:start!important;gap:0!important;position:relative!important}
 .pack.base>img,.pack.base>picture,.pack.base>[class*=img],.pack.base>[class*=fig]{width:130px!important;height:auto!important;max-width:130px!important;max-height:none!important;object-fit:contain!important;align-self:start!important;margin:0!important;border-radius:0!important;display:block!important;grid-column:1!important;grid-row:1!important}
 .pack.base>*:not(img):not(picture):not([class*=img]):not([class*=fig]){padding:12px 12px 12px 14px!important;align-self:start!important;grid-column:2!important;min-width:0!important;display:flex!important;flex-direction:column!important;justify-content:flex-start!important;gap:6px!important;position:relative!important}

 /* Tarja/badge amarela do preco (300 + moeda) — fica menor, em UMA linha, no canto sup direito */
 .pack.base [class*=preco],.pack.base [class*=price],.pack.base [class*=pktag],.pack.base [class*=pkprice],.pack.base [class*=pksoon],.pack.base [class*=badge-prec],.pack.base [class*=tag-amar],.pack.base [class*=amarel]{
  display:inline-flex!important;flex-direction:row!important;align-items:center!important;gap:4px!important;
  padding:3px 8px!important;font-size:11px!important;line-height:1!important;
 ...
 .pack.base [class*=preco] img,.pack.base [class*=preco] svg,.pack.base [class*=price] img,.pack.base [class*=price] svg{width:12px!important;height:12px!important;display:inline!important}

 /* Titulo TIME COMPLETO com margem-top pra nao ficar atras da tarja */
 .pack.base h3,.pack.base [class*=title],.pack.base [class*=pktitle]{font-size:17px!important;margin:32px 0 4px!important;line-height:1.15!important;font-weight:700;padding-right:0!important}
 .pack.base p,.pack.base [class*=desc],.pack.base [class*=sub]{font-size:13px!important;line-height:1.35!important;margin:0!important}
 .pack.base [class*=embreve]{font-size:11px!important;padding:4px 10px!important;display:inline-flex!important}
 .pack.base button,.pack.base [class*=btn]{padding:8px 14px!important;font-size:12px!important;width:100%!important;margin-top:6px!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-07 */
@media(max-width:600px){
 /* === Marketplace: CARD ALTURA = IMAGEM (195px) === */
 .grid:has(> .pack){grid-template-columns:1fr!important;gap:14px!important;padding-left:12px!important;padding-right:12px!important}
 .pack.base{display:grid!important;grid-template-columns:130px 1fr!important;grid-template-rows:195px!important;width:100%!important;max-width:100%!important;height:195px!important;min-height:195px!important;max-height:195px!important;padding:0!important;overflow:hidden!important;align-items:stretch!important;gap:0!important;position:relative!important}
 .pack.base>img,.pack.base>picture,.pack.base>[class*=img],.pack.base>[class*=fig]{width:130px!important;height:195px!important;max-width:130px!important;max-height:195px!important;object-fit:cover!important;align-self:stretch!important;margin:0!important;border-radius:0!important;display:block!important;grid-column:1!important;grid-row:1!important}
 .pack.base>*:not(img):not(picture):not([class*=img]):not([class*=fig]){padding:10px 12px!important;align-self:stretch!important;grid-column:2!important;min-width:0!important;max-height:195px!important;overflow:hidden!important;display:flex!important;flex-direction:column!important;justify-content:flex-start!important;gap:5px!important;position:relative!important}

 /* Tarja amarela 300 — pequena top right */
 .pack.base [class*=preco],.pack.base [class*=price],.pack.base [class*=pktag],.pack.base [class*=pkprice],.pack.base [class*=pksoon],.pack.base [class*=tag-amar],.pack.base [class*=amarel]{
  display:inline-flex!important;flex-direction:row!important;align-items:center!important;gap:4px!important;
  padding:2px 7px!important;font-size:10px!important;line-height:1!important;
  height:auto!important;width:auto!important;max-width:none!important;
  position:absolute!important;top:6px!important;right:6px!important;
  white-space:nowrap!important;border-radius:999px!important;z-index:2;
 }
 .pack.base [class*=preco] img,.pack.base [class*=preco] svg,.pack.base [class*=price] img,.pack.base [class*=price] svg{width:11px!important;height:11px!important;display:inline!important}

 .pack.base h3,.pack.base [class*=title],.pack.base [class*=pktitle]{font-size:15px!important;margin:26px 0 2px!important;line-height:1.15!important;font-weight:700;padding-right:0!important}
 .pack.base p,.pack.base [class*=desc],.pack.base [class*=sub]{font-size:12px!important;line-height:1.3!important;margin:0!important}
 .pack.base [class*=embreve]{font-size:10px!important;padding:3px 8px!important;display:inline-flex!important}
 .pack.base button,.pack.base [class*=btn]{padding:6px 12px!important;font-size:11px!important;width:100%!important;margin-top:auto!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-08 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-09 */
@media(max-width:600px){
 /* === Marketplace === */
...
/* POLISH-RUNNING-CSS 2026-06-13-10 */
@media(max-width:600px){
 /* Marketplace */
 .pack.base{height:auto!important;min-height:0!important;max-height:none!important;grid-template-columns:none!important;grid-template-rows:none!important;display:flex!important;flex-direction:column!important;align-items:center!important;padding:14px!important;overflow:visible!important;position:relative!important;gap:8px!important}
 .pack.base>img,.pack.base>picture,.pack.base>[class*=img],.pack.base>[class*=fig]{width:auto!important;height:auto!important;max-width:160px!important;max-height:none!important;object-fit:contain!important;grid-column:auto!important;grid-row:auto!important;margin:0 auto!important;display:block!important;align-self:center!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-11 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-12 */
@media(max-width:600px){
 /* HEADER escudo */
 .top .brand{flex:0 0 auto!important;max-width:42px!important;overflow:hidden!important}
 .top .brand .blogo,.top .brand img{max-height:32px!important;max-width:32px!important;width:auto!important;height:auto!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-13 */
@media(max-width:600px){
 /* HEADER escudo */
 .top .brand{flex:0 0 auto!important;max-width:42px!important;overflow:hidden!important}
 .top .brand .blogo,.top .brand img{max-height:32px!important;max-width:32px!important;width:auto!important;height:auto!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-14 */
@media(max-width:600px){
 .top .brand{flex:0 0 auto!important;max-width:42px!important;overflow:hidden!important}
 .top .brand .blogo,.top .brand img{max-height:32px!important;max-width:32px!important;width:auto!important;height:auto!important}
 .top .burger{flex:0 0 auto!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-15 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-18 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-19 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-20 */
@media(max-width:600px){
...
/* POLISH-RUNNING-CSS 2026-06-13-21 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-22 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-23 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-24 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-25 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
 .provcard.sel,.provcard.gem.sel{box-shadow:0 0 0 2px #1faa59 inset!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-27 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
 .provcard.sel,.provcard.gem.sel{box-shadow:0 0 0 2px #1faa59 inset!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-28 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
 .provcard.sel,.provcard.gem.sel{box-shadow:0 0 0 2px #1faa59 inset!important}
...
/* POLISH-RUNNING-CSS 2026-06-13-29 */
@media(max-width:600px){
 .pack.base{overflow:visible!important;position:relative!important}
 .pack.base button,.pack.base .btn{padding:8px 14px!important;font-size:13px!important;min-height:0!important;height:auto!important;line-height:1.2!important}
 .provcard.sel,.provcard.gem.sel{box-shadow:0 0 0 2px #1faa59 inset!important}
