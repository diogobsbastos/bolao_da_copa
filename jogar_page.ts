 ...
 <main class="main">
  ...
  <section class="sec" id="s-ia">
   ...
   <div class="card">
    ...
    <div class="iarow"><button class="btn" onclick="conectarIA()">&#128279; Conectar</button><button class="btn ghost" id="btn-gemini-help" onclick="ajudaGemini()">&#10024; Criar Gemini gr&aacute;tis</button><span id="ia-st" class="muted"></span></div>
    <div class="iarow" id="ia-actions" style="display:none"><button class="btn ghost" onclick="testarIA()">&#129514; Testar</button><button class="btn" onclick="salvarIA()">Salvar conex&atilde;o</button><span id="ia-st2" class="muted"></span></div>
   </div>
