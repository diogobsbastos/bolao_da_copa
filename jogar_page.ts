  ...
  <section class="sec" id="s-ia">
   ...
   <div class="card">
     ...
     <div id="step-key" style="display:none">
      ...
      <div class="iarow rgt"><span id="ia-st" class="muted" style="margin-right:auto"></span><button class="btn" id="btn-conn" onclick="conectarIA()" disabled>&#128279; Conectar</button></div>
     </div>
