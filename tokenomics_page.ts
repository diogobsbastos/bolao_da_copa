  ...
  <div class="pad">
   ...
   <section id="pg-usuarios" class="hide">
    <div class="card"><h3>&#128101; Engajamento dos jogadores</h3><div class="sub">Quem pagou, quem entrou de gra&ccedil;a, por qual convite, e quem convidou.</div>
     ...
     <div class="scroll"><table><thead><tr><th>Nome</th><th>E-mail</th><th>Pagou?</th><th>Como entrou</th><th>Convidou (quem usou)</th><th>Time</th><th style="font-size:11px">Entrou</th><th class="num">Saldo</th></tr></thead><tbody id="u-body"><tr><td colspan="6" class="muted">carregando...</td></tr></tbody></table></div>
    </div>
   </section>
...
async function loadUsuarios(){
 ...
 for(var i=0;i<L.length;i++){var u=L[i];if(u.papel==="admin")continue;
  ...
  h+='<tr><td>'+esc(u.nome||"&mdash;")+'</td><td>'+esc(u.email)+'</td><td>'+pagou+'</td><td>'+entrou+'</td><td style="font-size:12px">'+convidou+'</td><td>'+(u.tem_time?'<span style="background:#1faa59;color:#fff;font-size:10px;font-weight:800;padding:2px 7px;border-radius:999px;white-space:nowrap">&#9917; TIME ON</span>':'<span class="muted">&mdash;</span>')+'</td><td style="font-size:11px;color:var(--mut);white-space:nowrap">'+esc(u.criado||"&mdash;")+'</td><td class="num">'+u.saldo+'</td></tr>';
 }
